  ...
  return (
    <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 shadow-xl border border-white/20">
      <div className="text-center mb-8">
        ...
        <p className="text-gray-600">Share your current mood to get personalized recommendations</p>
      </div>
      ...
      <form onSubmit={handleSubmit} className="space-y-8">
        ...
        {/* Energy Level */}
        <div className="space-y-4">
          <label className="block text-lg font-semibold text-gray-700">Energy Level</label>
        ...
        {/* Current Activity */}
        <div className="space-y-4">
          <label className="block text-lg font-semibold text-gray-700">Current Activity</label>
            ...
            {activities.map((activity) => {
              ...
              return (
                ...
                >
                  ...
                  <span className="font-medium text-xs">{activity.label}</span>
                </button>
              );
            })}
          </div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-4 bg-gradient-to-r from-purple-600 to-pink-600 text-white font-semibold rounded-2xl hover:from-purple-700 hover:to-pink-700 transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none"
        >
